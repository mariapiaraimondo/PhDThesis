...
public final class ASimpleConditionPayload extends PConditionPayload
{
    private TOpaqueexpr _opaqueexpr_;

    public ASimpleConditionPayload()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASimpleConditionPayload(
    ...
    {
        ((Analysis) sw).caseASimpleConditionPayload(this);
    }
