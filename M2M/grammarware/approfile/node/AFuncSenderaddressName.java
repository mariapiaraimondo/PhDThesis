...
public final class AFuncSenderaddressName extends PSenderaddressName
{
    private PFuncName _funcName_;

    public AFuncSenderaddressName()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFuncSenderaddressName(
    ...
    {
        ((Analysis) sw).caseAFuncSenderaddressName(this);
    }
